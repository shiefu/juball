...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadChooseProject(){
            ...
            //alert('categorytype='+categorytype+', category='+category+', digit='+digit+', plan='+plan);
            ...
            //九州傳奇預測的title-位數
            $("#forecastDigit").text(digit_IDToChinese(digit));
            //九州傳奇預測的title-幾碼
        ...
        function latest_show() {
            ...
            var url, data;
            url =  './getLiveData.php?c=cqssc&a='+category+'_latest_show';
            if (category === 'yilou'){
                data = 'digit='+digit;
            }else{
        ...
        function data_show() {
            var category = getCategory(), digit = getDigit(), plan = getPlan();
            var url, data;
            url =  './getLiveData.php?c=cqssc&a='+category+'_data_show';
            if (category === 'yilou'){
                data = 'digit='+digit;
            }else{
                data = 'digit='+digit+'&plan='+plan;
        ...
        function data_chart() {
            ...
            $.ajax({
                url: './getLiveData.php?c=cqssc&a=yilou_chart',
                data: "digit="+digit,
                type: 'post',
                dataType: "json",
                timeout: 10000,
...
<nav class="navbar navbar-fixed-top navbar-inverse">
    <div class="container-fluid">
        <div class="container">
            <a href="/"><img src="/template/starball/Skin/images/img-sc/logo.png" alt="&#20061;&#21317;&#20659;&#22855;&#24425;&#31080;"></a>
        </div>
    </div>
</nav>
    ...
    <div class="row category_plan">
        ...
        <div class="spreadsheet">
            <div class="col-lg-8 col-md-8 col-sm-8 colxs-12 spreadsheet-left left" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;">
                ...
                <h3>※ 试算表水位由「<a href="http://www.ts977.net">九卅天下现金网提供</a>」!</h3>
            </div>
    ...
    <footer>
        <div class="row" style="background-color: black;">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 footer-right">
                ...
                <ul>
                    <li><i class="icon-qq"></i>QQ客服：574878203</li>
                    <li><i class="icon-wechat"></i>微信客服：az521688</li>
                    <li><i class="icon-mail-alt"></i>电邮：<a href="mailto:519591875@qq.com">519591875@qq.com</a></li>
                    <li><i class="icon-weibo"></i>官方微博：<a href="http://www.weibo.com/u/5984978153?topnav=1&amp;wvr=6&amp;topsug=1&amp;is_hot=1">九卅傳奇彩票</a></li>
