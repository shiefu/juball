(function(jQuery){
	...
	$.fn.BreakingNews = function(settings){
			...
			return this.each(function(){
				...
				//$(settings.modulid).css({'width':settings.width,'height':settings.height, 'background':settings.background, 'border':settings.border, 'font-size':settings.fonttextsize });
				//$(settings.modulid+' ul').css({'left':$(settings.modulid+' .bn-title').width()+25});
